...
export default function InputTextArea({ inputSpan, inputClassName, labelClassName, label, inputId, inputName,inputRows, inputPalceholder, inputDefaultValue, description , descriptionClassName,htmlForLabel  }: Props) {
    ...
    return (
        <div className={`col-span-6 sm:${opt[inputSpan] || "col-span-3"}`}>
            <label htmlFor={htmlForLabel} className={`${labelClassName} block text-sm font-medium text-gray-700`}>
                {label}
            </label>
            <div className="mt-1">
                <textarea
