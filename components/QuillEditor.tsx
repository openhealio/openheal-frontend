...
export default function QuillEditor({ userData }: Props): JSX.Element {
    ...
    const [editorState, setEditorState] = useState(userData ? userData["Modelos"]["Prescricao"] : null)
...
return (
    <>
        {userData && <button onClick={onClickButton} className="bg-blue-200 rounded mt-4 p-1">Prescrição</button>}
        <QuillNoSSRWrapper
